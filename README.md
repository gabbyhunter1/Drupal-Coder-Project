...
- [x] Написать полный HTML код страницы
- [x] Написать основные блоки SCSS кода
- [ ] Верстка:
  - [x] Навбар
  - [x] Заглавная секция
  - [x] Основная часть страницы
  - [ ] Контактная форма
  - [ ] Футер
...
Балабанов Виталий - [Twitter: @mjackson50\_](https://x.com/mjackson50_) - [Telegram: @mjackson50]() - vitalybalabanov50@gmail.com
